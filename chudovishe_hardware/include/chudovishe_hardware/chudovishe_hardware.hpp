...
#ifndef CHUDOVISHE_HARDWARE__DIFFBOT_SYSTEM_HPP_
#define CHUDOVISHE_HARDWARE__DIFFBOT_SYSTEM_HPP_
...
class ChudovisheSystemHardware : public hardware_interface::SystemInterface {
   public:
    RCLCPP_SHARED_PTR_DEFINITIONS(ChudovisheSystemHardware)
